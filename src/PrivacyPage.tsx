          ...
          <div className="container-x max-w-3xl space-y-14">
            ...
            <Block title="2. Ποια δεδομένα συλλέγουμε">
              ...
              <p>
                ...
                δεδομένων της ιστοσελίδας. Η ιστοσελίδα δεν συλλέγει άλλα προσωπικά δεδομένα κατά
                την απλή περιήγηση, πέραν όσων περιγράφονται στην ενότητα για τα cookies.
              </p>
            </Block>
            ...
            <Block title="6. Cookies & στατιστικά επισκεψιμότητας">
              ...
              <p>
                Μπορείτε να αλλάξετε την επιλογή σας ανά πάσα στιγμή:
              </p>
              <button
                type="button"
                onClick={() => {
